...
public class UserAuthTest {
  ...
  public void testAuthUser(){
    ...
    authData.put("email", "vinkotov@exampel.com");
    ...
    Headers heders = responseGetAuth.getHeaders();
    ...
    assertTrue(heders.hasHeaderWithName("x-csrf-token"), "Response doesn't have 'x-csrf-token' heders");
